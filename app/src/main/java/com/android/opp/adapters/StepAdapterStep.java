...
/**
 * Created by camilo on 5/7/17.
 */

public class StepAdapterStep extends ArrayAdapter {
    public StepAdapterStep(Context context, List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.image_individual_step, parent, false);
        }
