...
package com.android.opp.camera;
...
import com.android.opp.camera.custom.adapter.SpacesItemDecoration;
import com.android.opp.camera.util.Util;
...
public class ImagePickerActivity extends AppCompatActivity implements CameraHostProvider {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            int extracantidad=intent.getInt("cantidad");
            mConfig.setSelectionLimit(extracantidad);
            Log.v("aqui_extraaa",extracantidad+" ddd");
        }
